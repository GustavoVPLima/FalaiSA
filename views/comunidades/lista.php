...
<div class="page-header">
    <h1 class="text-nowrap-truncate">Minhas Comunidades</h1>
        ...
        <?php foreach ($communities as $community): ?>
            <div class="community-item">
                <div class="community-image">
                    <?php
                        $foto = !empty($community['img_perfil']) && file_exists($_SERVER['DOCUMENT_ROOT'] . '/static/uploads/comunidades/' . $community['img_perfil'])
                ...
                <div class="community-details">
                    ...
                    <p class="text-nowrap-truncate"><?php echo htmlspecialchars($community['ds_comunidade'] ?? ''); ?></p>
                    <p class="community-membros"><?php echo (int) ($community['total_membros'] ?? 0); ?> membros</p>
                    <div class="community-actions">
                        <?php
                            $isMember = ComunidadeDAO::isMember($_SESSION['id'] ?? null, $community['id_comunidade']);
                        ?>
